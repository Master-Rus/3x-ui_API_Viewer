...
L = {
    ...
    'update': "Update",
    'update_success': "Update completed successfully. The application will restart.",
    'update_error': "Update Error",
    'apply_update_error': "Failed to apply update:\n{}",
    'update_available': "Update Available",
    'update_prompt': "New version {} \nfound (current is {}). \nUpdate now?",
    'yes': "Yes",
    'no': "No",
    'checking_updates': "Checking for updates",
    'checking': "Checking for updates...",
    'checking_attempt': "Checking for updates... (attempt {}/{})",
    'error': "Error",
